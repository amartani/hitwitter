...
public interface ICentralRemote extends Remote {
	 ...
	 * Inicia uma chamada
	 * 
	 * @param origem Telefone de origem
	 * @param destino Telefone de destino
	 * @throws RemoteException
	 */
	public void efetuarChamada(Telefone origem, Telefone destino) throws RemoteException;
	
	/**
	 * O cliente deve chamar este método quando a chamada for encerrada pela parte do mesmo
	 * 
	 * @param telefone Telefone do cliente que encerrou a chamada
	 * @throws RemoteException
	 */
	public void informarChamadaEncerrada(Telefone telefone) throws RemoteException;
	
	/**
	 * O cliente deve chamar este método quando a chamada que está sendo conectada for rejeitada
	 * pelo mesmo 
	 * 
	 ...
	 * 
	 * @param origem Telefone de origem da mensagem
	 * @param mensagem Mensagem à ser enviada
	 * @throws RemoteException
	 */
	 ...
	 * 
	 * @param origem Telefone de origem da requisicao
	 * @param requisicao Requisicao a ser efetuada
	 * @throws RemoteException
	 */
