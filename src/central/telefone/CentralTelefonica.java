...
public class CentralTelefonica implements ICentralTelefonica {
	...
	private ICentralTelefonicaSaidaRemote central;

	public CentralTelefonica(ICentralTelefonicaSaidaRemote central,
			IGerenciamentoEntrada gerenciamento) {
	...
	@Override
	public void cancelarChamada(Telefone telefone) {
		gerenciadorChamadas.informarChamadaCancelada(telefone);
	...
	public void informarChamadaCancelada(Telefone telefone)
			throws RemoteException {
		central.informarChamadaCancelada(telefone);
